...
research_task = Task(
    description=(
        ...
        "to retrieve relevant information, including financial reports, summaries, and key points from multiple sources. "
        "Gather enough data to provide a comprehensive overview of the topic."
    ),
    expected_output=(
        "A structured, bullet-pointed summary including:\n"
        "- Key facts, financial reports and insights from multiple sources\n"
